...
const MIN_PER_DAY = 1
// Внешний cron (cron-job.org) проверяет расписание раз в 15 минут — просить
// доставку чаще, чем раз в час, уже почти не имеет смысла: реальная частота
// всё равно упрётся в этот шаг проверки. 24 = раз в час, с запасом.
